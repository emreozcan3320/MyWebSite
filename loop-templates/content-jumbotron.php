...
<div class="container-fluid jumbotron_container" style="background-image: url('<?php echo $image[0]; ?>'); background-size:cover">
  <div class="jumbotron p-3 p-md-5 text-white rounded jumbotron_custom">
      <div class="col-md-6 px-0">
            <?php the_title(
			sprintf( '<h1 class="display-4 font-italic "><a class="text-white"  href="%s" rel="bookmark">', esc_url( get_permalink() ) ),
			'</a></h1>'
		    );?>
        ...
        <p class="lead mb-0 h3 font-italic jumbotron_read_more"><a href="<?php echo esc_url( get_permalink());?>" class="text-white font-weight-bold">Continue reading...</a></p>
      </div>
    </div>
</div>